...
# Asosiy reklama/marketing kanali — "Ko'proq Animelar" tugmasi va har bir video
# tagidagi "Asosiy kanal" yozuvi shu yerga yo'naltiradi (majburiy obuna kanallaridan
# MUSTAQIL — ular o'zgarsa ham, bu havola doim shu bo'lib qoladi).
MAIN_CHANNEL_URL = os.getenv("MAIN_CHANNEL_URL", "https://t.me/SenpaiTvUZ")
MAIN_CHANNEL_NAME = os.getenv("MAIN_CHANNEL_NAME", "@SenpaiTvUZ")
