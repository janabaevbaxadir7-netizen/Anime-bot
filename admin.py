    ...
    for ch in channels:
        try:
            ...
            if video_file_id:
                ...
                # biriktirish MUMKIN EMAS — shu sabab avval rasm+video albom qilib
                # (tavsif rasm ostida) yuboriladi, so'ng darhol tugmali alohida xabar ketadi.
                await bot.send_media_group(
                    chat_id=ch.chat_id,
                    media=[
                        InputMediaPhoto(media=photo_file_id, caption=full_caption, parse_mode="HTML"),
