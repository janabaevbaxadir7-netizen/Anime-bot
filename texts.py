...
def time_greeting():
    ...
    if 6 <= h < 11:   return "🌸 Xayrli tong... uyg'ondingmi? Bugun ham yoqimli kun bo'lsin."
    elif 11 <= h < 18: return "☁️ Kunduzning bir lahzasini o'zingga ajratdingmi? Yaxshi tanlov."
    elif 18 <= h < 23: return "🌇 Kech kirdi... issiq choy va sevimli anime — mukammal juftlik."
    else:              return "🌙 Tun sokin... uxlashdan oldin bitta qism, xohlaysanmi?"
...
# ── FOYDALANUVCHI ──
WELCOME_INTRO = (
    "⛩️ <i>...sakura gullari sekin uchib tushmoqda...</i>\n\n"
    "🌸 <b>Yuki:</b> Salom. Xursandman sen keldingiz.\n"
    "Bu yerda o'zingni erkin his qil — <b>Sakura Olami</b> senga ochiq ✨"
)
