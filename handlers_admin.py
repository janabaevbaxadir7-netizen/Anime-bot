...
# ── FOYDALANUVCHI MENYUSIDAGI "⚙️ Admin panel" TUGMASI (faqat adminlarga ko'rinadi) ──
@router.message(F.text == texts.MENU_ADMIN_PANEL, IsAdmin())
async def admin_panel_from_user_mode(message: Message, state: FSMContext):
    await show_admin_panel(message, state)
